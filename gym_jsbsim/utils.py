...
def get_env_id_kwargs_map() -> Dict[str, Tuple]:
    ...
    from gym_jsbsim.heading_control_task import HeadingControlTask, TurnHeadingChangeLevelControlTask, HeadingControlTask_1Bis, ChangeHeadingControlTask

    map = {}
    for task_type in (HeadingControlTask, TurnHeadingChangeLevelControlTask,HeadingControlTask_1Bis, ChangeHeadingControlTask):
